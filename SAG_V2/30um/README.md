...
**Check the job name, not the mass.** The console prints `Abaqus JOB sagv2_30um`.
That is the only identifier that distinguishes this build from an earlier one.

The packager reports a model mass of **9.28000e-14** — the workpiece alone.
...
14.75 nm standoff, which the smooth-step ramp covers by
