@echo off
cd /d "%~dp0"
rem  30 um pad -- SAG on HVOF WC-Co, after Ghosh et al. 2021.
rem
...
echo.
echo  datacheck passed. Starting the solve -- about 96 h on 8 cores.
echo.
call abaqus job=micro_30um input=micro_30um.inp user=vumat_grind2.for double=both cpus=8 interactive
