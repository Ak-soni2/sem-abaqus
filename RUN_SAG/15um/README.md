...
- `micro_15um_sdv13.csv` — brittle fraction for **every frame of every pass**
- `micro_15um_summary.json` — the pass at which brittle elements first appear
