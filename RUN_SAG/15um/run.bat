...
call abaqus job=micro_15um input=micro_15um.inp user=vumat_grind2.for double=both cpus=1 datacheck
if errorlevel 1 (
  echo.
  echo  DATACHECK FAILED -- read micro_15um.dat, the error is a keyword or the
