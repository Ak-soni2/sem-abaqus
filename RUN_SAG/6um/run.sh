...
abaqus job=micro_6um_check input=micro_6um.inp user=vumat_grind2.for double=both cpus=1 datacheck || {
  echo "DATACHECK FAILED -- read micro_6um_check.dat. Nothing has been solved yet." >&2
  exit 1
}
